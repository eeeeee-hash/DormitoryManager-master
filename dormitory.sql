...
CREATE TABLE `d_admin`  (
  ...
  `a_phone` bigint NULL DEFAULT NULL,
...
-- Records of d_admin
-- ----------------------------
INSERT INTO `d_admin` VALUES (1, 'yang', '57CB5A26334A6C1D5E27C49DEF4A0F0D', '杨霜', 19936045048, '1', '高');
INSERT INTO `d_admin` VALUES (2, 'zj', '696E25FDACEE8106BC5232AFC69155D6', '张杰', 13813813843, '2', '低');
INSERT INTO `d_admin` VALUES (3, 'zh', '696E25FDACEE8106BC5232AFC69155D6', '张欢', 13813813823, '1', '高');
INSERT INTO `d_admin` VALUES (4, 'zk', '696E25FDACEE8106BC5232AFC69155D6', '赵凯', 13813813843, '2', '低');
INSERT INTO `d_admin` VALUES (5, 'ywj', '696E25FDACEE8106BC5232AFC69155D6', '杨雯雯', 13813813823, '1', '高');
INSERT INTO `d_admin` VALUES (6, 'wh', '696E25FDACEE8106BC5232AFC69155D6', '王皓', 13813813813, '1', '高');
INSERT INTO `d_admin` VALUES (7, 'zw', '696E25FDACEE8106BC5232AFC69155D6', '张伟', 13813813823, '2', '低');
INSERT INTO `d_admin` VALUES (8, 'zj', '696E25FDACEE8106BC5232AFC69155D6', '赵佳', 13813813842, '2', '低');
INSERT INTO `d_admin` VALUES (9, 'wf', '696E25FDACEE8106BC5232AFC69155D6', '王凡', 13813813823, '1', '高');
INSERT INTO `d_admin` VALUES (10, 'zn', '696E25FDACEE8106BC5232AFC69155D6', '张娜', 13813813823, '1', '高');
INSERT INTO `d_admin` VALUES (11, 'jzh', '696E25FDACEE8106BC5232AFC69155D6', '蒋子华', 13813813823, '2', '低');
INSERT INTO `d_admin` VALUES (12, 'xl', '696E25FDACEE8106BC5232AFC69155D6', '薛磊', 13813813823, '2', '低');
INSERT INTO `d_admin` VALUES (14, 'admin', '21232F297A57A5A743894A0E4A801FC3', '刘蓝潇', 13245231242, '2', '低');
...
INSERT INTO `d_class` VALUES (11, 111, '计算机', '苏琴');
...
INSERT INTO `d_dormgrade` VALUES (8, 301, '24号楼', 5, '2022-05-19 16:01:43', '2022-05-19 16:01:43');
...
INSERT INTO `d_dormitoryinfo` VALUES (15, 1125, '慧园', '6', '1', '杨霜');
...
CREATE TABLE `d_stgrade`  (
  ...
  `s_classid` int NULL DEFAULT NULL,
  `s_dormitoryid` int NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`g_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `d_student`  (
  ...
  `s_phone` bigint NULL DEFAULT NULL,
...
CREATE TABLE `d_visitor`  (
  ...
  `v_phone` bigint NULL DEFAULT NULL,
  `v_dormitoryid` int NULL DEFAULT NULL,
...
INSERT INTO `d_visitor` VALUES (10, '杨霜', 19936045032, 301, '24号楼', '2022-05-19 16:01:02');
